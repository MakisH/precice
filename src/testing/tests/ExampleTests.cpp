 ...
 * part of a test.
 * In this case, you can simply create the participants.
...
{
  // As we will use the participant, we do require anything else here.
  ...
  if (context.isNamed("Solid")) {
    ...
    // You can now create a participant for your first participant
    // You can use context.name, context.rank, context.size
  } else {
    // This is the participant Solid
    BOOST_TEST(context.hasSize(2));

    // You can now create a participant for your second participant
    // You can use context.name, context.rank, context.size
  }
}
