      ...
      _accessorCommunicatorSize(solverProcessSize)
{
  ...
  PRECICE_CHECK(!_accessorName.empty(),
                ...
                "When constructing a preCICE participant you need to pass the name of the "
  ...
  PRECICE_CHECK(_accessorProcessRank >= 0,
                ...
                "Please check the value given when constructing a preCICE participant.",
  ...
  PRECICE_CHECK(_accessorProcessRank < _accessorCommunicatorSize,
                ...
                "Please check the values given when constructing a preCICE participant.",
  ...
  PRECICE_CHECK(_accessorProcessRank == currentRank,
                "The solver process index given in the preCICE participant constructor({}) does not match the rank of the passed MPI communicator ({}).",
  ...
  PRECICE_CHECK(_accessorCommunicatorSize == currentSize,
                "The solver process size given in the preCICE participant constructor({}) does not match the size of the passed MPI communicator ({}).",
    ...
    const config::SolverInterfaceConfiguration &config)
{
  ...
  PRECICE_ERROR("This participant's name, which was specified in the constructor of the preCICE participant as \"{}\", "
